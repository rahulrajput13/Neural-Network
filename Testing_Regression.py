...
ch = datasets.fetch_california_housing(return_X_y=True, as_frame=True)
print(ch[0].head())
print(ch[1].head())

# Split dataset into training set and test set
X_train, X_test, y_train, y_test = train_test_split(ch[0], ch[1], test_size=0.2, random_state=1) # 80% training and 20% test
